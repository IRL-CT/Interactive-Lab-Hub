...
- The concept is creative and novel, with an interesting story.  
- Some confusion arose due to unclear documentation: missing or fewer storyboards than expected, unclear purpose of certain elements (like the glowing sword), and uncertainty about how the device functions (e.g., detecting poison, color meanings).  
- One praised the exploration of alternatives and originality beyond standard solutions.  

**Technical Execution**  
- All three noted strong technical execution.  
- Praises included: effective use of drawings, paper cutouts, solid prototyping, few errors, and thoughtful handling of details.  
- No major technical weaknesses were raised.  

**Communication of Idea / Documentation of Process**  
- Mixed feedback:  
  - Strength: Clear visuals and explanations, with documentation of steps and design choices (per one assessor).  
  - Weaknesses: Lack of clarity about device purpose, what colors signify, or why certain features exist (like the glowing sword). One person also mentioned missing feedback in Part A Plan.  

**Tested with User**  
- Videos were praised for being artistic and well executed.  
- One person noted reflections were included but lacked external user feedback.  
- Another highlighted that user feedback was gathered and used to refine the design, showing attention to usability.  
...
\*\***Include pictures of your storyboards here**\*\*   
**1. The first storyboard demonstrates how the prop’s lighting effect can change the mood of a scene.**   
- In Storyboard frames 1–3, the fruit plate is shown under different lighting: neutral, red, and orange. These variations signal shifting meanings, such as normal, danger, or tension.  
- In Storyboard frames 4–6, the pumpkin is lit with neutral, dark, and warm orange light. The changes highlight different atmospheres, from calm to eerie to intense.  
...
### <mark>1. Auto Flash based on Tinkerbelle.</mark>  
...
### <mark>2. Sound Effects based on Tinkerbelle.</mark>  
...
### <mark>3. Screen Shake based on Tinkerbelle.</mark> 
Finally, we added a screen shake effect to imitate the viberation of the tool, which focus on the sound effect of a wine cup due to the restriction of ios system.  
...
### <mark>4. Limitations & Decisions</mark>    
...
Next videos demonstrate the prototyped interaction for our Lab1b sound effects function. The device is used as a stage prop controller that triggers different sound effects in real time during a performance. In the video, six distinct sounds — thunder, laughter, eating, drum, explosion, and applause — are assigned to buttons on the controller. When pressed, the corresponding sound is immediately played on the stage prop device (a smartphone).   
[Watch the video for sound-effects prototype triggering **explosion** and **thunder** on YouTube](https://youtu.be/xM0MV5j1-60)   
[Watch the video for sound-effects prototype triggering **laugher**, **eating**, **cheers** on YouTube](https://youtu.be/G2aA-YXLc8Y?si=kg5IEFqaYFNeC0AA)
...
## Reflection   
Working on this Lab allowed our team to combine different interactive effects into a cohesive stage experience. I was responsible for coding and designing the automatic lighting function, while Qinrui Li developed the vibration effect and Jiayi Sun (Joy) focused on the sound effect. Through this collaboration, we realized how different sensory elements can complement each other—lighting draws the audience’s attention visually, vibration adds a physical layer of immersion, and sound enhances the emotional atmosphere. The integration of these features not only improved the expressiveness of our prototype but also taught us the importance of teamwork in merging diverse ideas into a unified theatrical design.

During user testing, participants responded positively to the prototype. They found the automatic lighting function engaging, as the smooth transitions between red, orange, and yellow made the fruit plate prop more noticeable on stage. The vibration effect was described as adding a sense of immersion, while the sound effect helped create atmosphere and guide attention. Testers also highlighted how the combination of these three elements worked well together, producing a richer and more dynamic theatrical experience. Overall, the feedback confirmed that our prototype successfully enhanced visibility, atmosphere, and audience engagement.
