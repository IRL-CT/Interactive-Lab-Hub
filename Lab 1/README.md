...
(disclaimer: last 3 storyboards were generated by ChatGPT through the following prompts: 1) Generate a simple comic of someone who is gaming and their device is low on battery. They are able to quickly charge their device while focusing on the game, and when the light turns green from red, they can continue the game without it being plugged in. 2) Generate a similar comic of someone who is at a coffee shop and has to leave to pick up their order, but they can see that their phone is charged as the light turns from red to green. 3) Similarly, generate a short comic of someone who is on a hike at nighttime, and they can see the light indicating their device charge level through their backpack and in the dark.)
