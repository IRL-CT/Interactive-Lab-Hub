...
**View the storybaords more comprehesively here: https://docs.google.com/document/d/1ozLUDDKiFT46ehj-3816TM5In5ePk1lSdjd8KqgHWms/edit?usp=sharing
**
...
Note: we used the laptop to test the device since we do not have the resources to recreate the device (ie. neon light or color-changing light bulb). All three videos are edited into the above video. 
...
Our new prototype uses a lamp light, vibrations, and soft chimes to indicate room changes. See costumes here: [costumes Ib.pdf](https://github.com/user-attachments/files/22198508/costumes.Ib.pdf)
