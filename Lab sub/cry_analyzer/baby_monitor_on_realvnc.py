...
NOW DISPLAYS ON MAIN SCREEN - VISIBLE IN REALVNC!
...
import os
os.environ['DISPLAY'] = ':0'  # Use main display for VNC
...
pygame.display.set_caption("Baby Monitor - Auto Detection")
...
def main():
    ...
    print(f"\nDisplay: {DISPLAY_WIDTH}x{DISPLAY_HEIGHT} Pygame Window")
    print("VISIBLE IN REALVNC!")
    print("="*60)
