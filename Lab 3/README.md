...
\*\***Then answer: the same greeting, in these different voices, is not the same greeting. Describe one concrete way the voice changed what the utterance seemed to mean or who seemed to be speaking.**\*\*
